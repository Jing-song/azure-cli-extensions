...
class Update(AAZCommand):
    ...
    def _build_arguments_schema(cls, *args, **kwargs):
        ...
        _args_schema.parameters_schema = AAZObjectArg(
            options=["--parameters-schema"],
            arg_group="Properties",
            help="The parameters schema of integration account map.",
            nullable=True,
        )

        parameters_schema = cls._args_schema.parameters_schema
        parameters_schema.ref = AAZStrArg(
            options=["ref"],
    ...
    class InstanceUpdateByJson(AAZJsonInstanceUpdateOperation):
        ...
        def _update_instance(self, instance):
            ...
            if properties is not None:
                ...
                properties.set_prop("parametersSchema", AAZObjectType, ".parameters_schema")

            parameters_schema = _builder.get(".properties.parametersSchema")
            if parameters_schema is not None:
                parameters_schema.set_prop("ref", AAZStrType, ".ref")
