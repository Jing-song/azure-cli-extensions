...
class List(AAZCommand):
    """List a list of integration accounts by resource group.
    """
    ...
    def _execute_operations(self):
        ...
        if condition_0:
            self.IntegrationAccountsListBySubscription(ctx=self.ctx)()
        if condition_1:
            self.IntegrationAccountsListByResourceGroup(ctx=self.ctx)()
    ...
    class IntegrationAccountsListBySubscription(AAZHttpOperation):
        ...
        def _build_schema_on_200(cls):
            ...
            integration_service_environment = cls._schema_on_200.value.Element.properties.integration_service_environment
    ...
    class IntegrationAccountsListByResourceGroup(AAZHttpOperation):
        CLIENT_TYPE = "MgmtClient"
